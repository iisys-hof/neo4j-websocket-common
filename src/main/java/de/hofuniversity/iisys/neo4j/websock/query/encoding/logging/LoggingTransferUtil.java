 ...
 */
public class LoggingTransferUtil implements Cloneable
{
    private final LoggingStringTransferUtil fStrings;
    private final LoggingBinaryTransferUtil fBinary;
     ...
     */
    public LoggingTransferUtil(LoggingStringTransferUtil strings,
        LoggingBinaryTransferUtil binary)
    {
        if(strings == null)
        {
     ...
     */
    public LoggingTransferUtil clone()
    {
        LoggingStringTransferUtil stUtil = fStrings.clone();
        LoggingBinaryTransferUtil btUtil = fBinary.clone();

        LoggingTransferUtil tu = new LoggingTransferUtil(stUtil, btUtil);
